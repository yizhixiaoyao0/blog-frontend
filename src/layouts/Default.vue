<template>
  <div>
    ...
    >
      ...
      >
      <a
        href="https://github.com/yizhixiaoyao0/blog-frontend"
        class="btn"
        target="_blank"
        v-if="!mini"
        >博客源码</a
        ...
        <el-row>
          ...
          <el-col :span="2" style="text-align: center;">
            ...
            <el-popover
              ...
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>&emsp;{{ strUserName }}
              <br />
              <i class="el-icon-location"></i>&emsp;{{ location }}
              <br />
              <img :src="GRIDSOME_API_URL+img" style="width: 200px;height: 200px;" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
